      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <img 
              src="/assets/photos/freelancer-workspace.jpg" 
              alt="Freelancer working with confidence"
              className="rounded-xl shadow-xl"
            />
            {/* Security badge - smaller, bottom center */}
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-white rounded-xl shadow-2xl px-6 py-3 border border-gray-200 max-w-xs">
