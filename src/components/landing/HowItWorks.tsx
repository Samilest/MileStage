        ...
        <div className="space-y-24">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-4">
                Deliver, Get Approved, Get Paid
              </h3>
              <p className="text-lg text-gray-600 mb-4">
                Upload deliverables. Client approves. Client pays. Next stage unlocks automatically.
              </p>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>You deliver files → Client reviews & approves → Payment unlocks</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>Once paid, next stage unlocks instantly</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>Client portal auto-sent. No signup required for clients.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm text-gray-500">(optional, customizable)</span>
                  </div>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
