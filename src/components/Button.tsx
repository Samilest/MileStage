...
export default function Button({
  ...
  const baseStyles = 'flex items-center justify-center px-4 sm:px-6 py-1.5 sm:py-2 rounded-lg font-semibold transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 text-sm sm:text-base transform hover:scale-105 active:scale-95';
