  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
        ...
        <div>
          {/* Info Badge for Client - Work in Progress */}
          {readOnly && stage.status !== 'delivered' && stage.status !== 'locked' && stage.deliverables.length > 0 && (
          ...
          {/* Info Badge for Freelancer - Work in Progress */}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-blue-800 leading-relaxed">
                    If the client requests substantial changes via notes, click "Use Revision" below to track it. This protects you from scope creep.
                  </p>
                </div>
              </div>
            </div>
